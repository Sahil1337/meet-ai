...
Then set `"name": "@meetiq/api"`, add `"@meetiq/ai": "workspace:*"`,
`"@meetiq/core": "workspace:*"`, `"@meetiq/tsconfig": "workspace:*"`, a
`tsconfig.json` extending `@meetiq/tsconfig/base.json`, and `dev`/`typecheck`
